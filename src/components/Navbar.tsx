      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-8">
            <h1 className="text-2xl font-black text-white tracking-tighter cursor-pointer" onClick={() => navigate('/')}>
              AHAA
            </h1>
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <>
                <button className="flex items-center gap-1 text-white hover:text-emerald-200 transition-colors" onClick={() => navigate('/chat')}>
                  <MessageSquare className="h-5 w-5" />
                  <span className="hidden sm:inline text-sm font-medium">Messages</span>
                </button>
                <button className="flex items-center gap-1 text-white hover:text-emerald-200 transition-colors" onClick={() => navigate('/orders')}>
